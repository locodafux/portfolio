...
const Skills = () => {
  ...
  return(
    <div id = "skills" className = "flex flex-col items-center flex-1 lg:min-h-screen w-screen pb-12 ">
      ...
      <div className="w-screen flex justify-center gap-x-3 lg:text-5xl  text-4xl">
        <span >My</span> <span className = " font-bold">Skills</span>
      </div>

      <div className="mt-12 grid lg:grid-cols-4 gap-12 w-full max-w-6xl  place-items-center">
        {
