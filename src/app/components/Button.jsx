const CustomButton = ({children, href, download}) => {
  return (
    <a href={href} download={download} className="text-lg font-bold bg-gray-900 text-white p-4 flex items-center gap-x-2 hover:text-gray-900 hover:bg-white transition">
      <svg
